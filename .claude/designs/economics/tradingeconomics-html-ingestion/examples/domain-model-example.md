...
## IndicatorCategory (domain/model)
...
## GlobalEconomicIndicatorType (domain/model)
...
public enum GlobalEconomicIndicatorType {
    ...
    MILITARY_EXPENDITURE(FISCAL_STATE, "military-expenditure", "군사비 지출");
...
public class IndicatorValue {
    ...
    private final BigDecimal numericValue;  // nullable
    private final String unit;
}
```

## CountryIndicatorSnapshot (domain/model)
...
public class CountryIndicatorSnapshot {
    ...
    private final IndicatorValue previousValue;     // nullable
    private final String referenceText;             // 원문 보존 (예: "2026-01")
    private final LocalDateTime collectedAt;
}
```

## GlobalIndicatorPort (domain/service)
