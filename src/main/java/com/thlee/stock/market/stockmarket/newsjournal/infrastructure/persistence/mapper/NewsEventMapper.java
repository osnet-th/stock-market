 ...
 * 본체({@link NewsEvent}) + 자식({@link NewsEventLink}) 두 모델 × 2 방향 = 4 static 메서드.
 */
public final class NewsEventMapper {
    ...
    public static NewsEventEntity toEntity(NewsEvent d) {
        return new NewsEventEntity(
                d.getId(), d.getUserId(), d.getTitle(), d.getOccurredDate(), d.getCategory(),
                d.getWhat(), d.getWhy(), d.getHow(),
